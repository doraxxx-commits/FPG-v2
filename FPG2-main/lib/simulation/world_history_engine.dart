...
class WorldHistoryEngine {
  ...
  void processSeason({required List<Club> clubs, required Map<String, int> positions}) {
    for (final club in clubs) {
      ...
      club.historicalReputation = (club.historicalReputation + leaguePressure).clamp(10, 100);
      club.reputation = ((club.reputation * 0.96) + (club.historicalReputation * 0.04)).round().clamp(1, 100);
