class Club {
  ...
  Map<String, dynamic> toJson() => {
    ...
    'stability': stability, 'managerStyle': managerStyle, 'managerId': managerId, 'managerName': managerName,
  ...
  factory Club.fromJson(Map<String, dynamic> j) => Club(
    ...
    academyQuality: j['academyQuality'] ?? 50, stability: j['stability'] ?? 70, managerStyle: j['managerStyle'] ?? 'balanced',
