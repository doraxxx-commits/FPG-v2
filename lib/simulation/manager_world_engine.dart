...
class ManagerWorldEngine {
  ...
  void changeManager(Club club) {
    ...
    if (pool.isEmpty) {
      ...
      club.managerQuality = (club.managerQuality + random.nextInt(21) - 10).clamp(30, 95);
      club.managerReputation = (club.managerReputation + random.nextInt(17) - 8).clamp(20, 95);
      club.tacticalIdentity = (club.tacticalIdentity + random.nextInt(25) - 12).clamp(20, 95);
    } else {
      pool.sort((a, b) {
